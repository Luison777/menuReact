...
export default function ApetizersPage() {
  ...
  return (
      <>
        <p className="block  w-full ml-2 text-2xl Mexicanero text-center text-white neonGreen">Appetizers</p>
        {dishes.map((obj,idx)=> <CardFood key={idx} dish={obj.dish} ingredients={obj.ingredients} price={obj.price} src={obj.src}></CardFood>)}
        <p className="block  w-full ml-2 text-2xl Mexicanero text-center text-white neonGreen">Salads</p>
